  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3 14.5C3 14.0523 3.44772 13.5 4 13.5H12C12.5523 13.5 13 14.0523 13 14.5V13.5V6.5H9.5H8V5V1.5H3V13.5V14.5C3 14.0523 3.44772 13.5 4 13.5H12C12.5523 13.5 13 14.0523 13 14.5V13.5V6.5H9.5H8V5V1.5H3V13.5V14.5ZM14.5 13.5V6.5V5.41421C14.5 5.149 14.3946 4.89464 14.2071 4.70711L9.79289 0.292893C9.60536 0.105357 9.351 0 9.08579 0H8H3H1.5V1.5V13.5C1.5 14.8807 2.61929 16 4 16H12C13.3807 16 14.5 14.8807 14.5 13.5ZM9.5 5V2.12132L12.3787 5H9.5ZM5 8H4.5V6.5H5H10.5H11V8H10.5H5ZM4.5 10.5H5H9.5H10V12H9.5H5H4.5V10.5Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1.5 2.5C1.5 1.94772 1.94772 1.5 2.5 1.5H13.5C14.0523 1.5 14.5 1.94772 14.5 2.5V13.5C14.5 14.0523 14.0523 14.5 13.5 14.5H2.5C1.94772 14.5 1.5 14.0523 1.5 13.5V2.5ZM0 2.5C0 1.11929 1.11929 0 2.5 0H13.5C14.8807 0 16 1.11929 16 2.5V13.5C16 14.8807 14.8807 16 13.5 16H2.5C1.11929 16 0 14.8807 0 13.5V2.5ZM6 3.5H10V6.5H6V3.5ZM6 8H10V12.5H6V8ZM11.5 8H14.5V12.5H11.5V8ZM4.5 8H1.5V12.5H4.5V8ZM1.5 6.5H4.5V3.5H1.5V6.5ZM14.5 3.5H11.5V6.5H14.5V3.5Z"
        fill="currentColor"
      />
    </svg>
  );
